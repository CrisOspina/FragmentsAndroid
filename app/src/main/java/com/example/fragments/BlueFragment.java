...
public class BlueFragment extends Fragment {
    ...
    //Atributos del fragmento Blue
    Button btnFragmentBlue;
    View view;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        //Permitit comunicar con el fragment
        view = inflater.inflate(R.layout.fragment_blue, container, false);
        btnFragmentBlue = view.findViewById(R.id.btnBlue);
        btnFragmentBlue.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(getContext(),"Fragment Blue", Toast.LENGTH_SHORT).show();
            }
        });
        return  view;
    }
